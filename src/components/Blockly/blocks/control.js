...
import {CONTROL_CATEGORY_HUE, INPUT, OUTPUT, YailTypeToBlocklyType} from "./utilities.ts";
...
Blockly.Blocks['controls_if'] = {
  ...
  init: function () {
    ...
    this.appendValueInput('IF0')
      .setCheck(YailTypeToBlocklyType("boolean", INPUT))
...
Blockly.Blocks['controls_for_each_dict'] = {
  ...
  init: function() {
    this.setColour(CONTROL_CATEGORY_HUE);
    var checkTypeDict = YailTypeToBlocklyType(
      'dictionary', INPUT);
