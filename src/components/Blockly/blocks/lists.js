...
import {INPUT, LIST_CATEGORY_HUE, OUTPUT, YailTypeToBlocklyType} from "./utilities.ts";
...
Blockly.Blocks['lists_create_with'] = {
  ...
  init: function() {
    this.setColour(LIST_CATEGORY_HUE);
    this.appendValueInput('ADD0')
      .appendField(Blockly.Msg.LANG_LISTS_CREATE_WITH_TITLE_MAKE_LIST);
    this.appendValueInput('ADD1');
    this.setOutput(true, YailTypeToBlocklyType("list",OUTPUT));
...
Blockly.Blocks['lists_add_items'] = {
  ...
  init: function() {
    ...
    this.appendValueInput('LIST')
      .setCheck(YailTypeToBlocklyType("list",INPUT))
...
Blockly.Blocks['lists_is_in'] = {
  ...
  init : function() {
    this.setColour(LIST_CATEGORY_HUE);
    const checkTypeList = YailTypeToBlocklyType("list", INPUT);
    const checkTypeAny = YailTypeToBlocklyType("any", INPUT);
    this.interpolateMsg(Blockly.Msg.LANG_LISTS_IS_IN_INPUT,
      ...
      Blockly.ALIGN_RIGHT);
    this.setOutput(true, YailTypeToBlocklyType("boolean",OUTPUT));
...
Blockly.Blocks['lists_length'] = {
  ...
  init : function() {
    this.setColour(LIST_CATEGORY_HUE);
    this.setOutput(true, YailTypeToBlocklyType("number",OUTPUT));
    this.appendValueInput('LIST')
      .setCheck(YailTypeToBlocklyType("list",INPUT))
...
Blockly.Blocks['lists_select_item'] = {
  ...
  init : function() {
    ...
    this.setOutput(true, null);
    const checkTypeList = YailTypeToBlocklyType("list", INPUT);
    const checkTypeNumber = YailTypeToBlocklyType("number", INPUT);
...
Blockly.Blocks['lists_to_csv_row'] = {
  ...
  init : function() {
    this.setColour(LIST_CATEGORY_HUE);
    this.setOutput(true, YailTypeToBlocklyType("text",OUTPUT));
    this.appendValueInput('LIST')
      .setCheck(YailTypeToBlocklyType("list",INPUT))
...
Blockly.Blocks['lists_from_csv_row'] = {
  ...
  init : function() {
    ...
    this.appendValueInput('TEXT')
      .setCheck(YailTypeToBlocklyType("text",INPUT))
...
Blockly.Blocks['lists_lookup_in_pairs'] = {
  ...
  init : function() {
    this.setColour(LIST_CATEGORY_HUE);
    this.setOutput(true, YailTypeToBlocklyType("any",OUTPUT));
    const checkTypeList = YailTypeToBlocklyType("list", INPUT);
    const checkTypeNumber = YailTypeToBlocklyType("number", INPUT);
    const checkTypeAny = YailTypeToBlocklyType("any", INPUT);
...
Blockly.Blocks['lists_join_with_separator'] = {
  ...
  init : function() {
    ...
    this.setOutput(true, YailTypeToBlocklyType("text",OUTPUT));
    const checkTypeList = YailTypeToBlocklyType("list", INPUT);
    const checkTypeText = YailTypeToBlocklyType("text", INPUT);
    ...
    this.appendValueInput('SEPARATOR')
      ...
      .appendField(Blockly.Msg.LANG_LISTS_JOIN_WITH_SEPARATOR_TITLE_JOIN)
      .appendField(Blockly.Msg.LANG_LISTS_JOIN_WITH_SEPARATOR_INPUT_SEPARATOR);
    this.appendValueInput('LIST')
      .setCheck(checkTypeList)
      .appendField(Blockly.Msg.LANG_LISTS_JOIN_WITH_SEPARATOR_INPUT_LIST);
...
Blockly.Blocks['lists_map'] = {
  ...
  freeVariables: function() { // return the free lexical variables of this block
    ...
    const result = Blockly.LexicalVariable.freeVariables(this.getInputTargetBlock(this.bodyInputName));
...
Blockly.Blocks['lists_filter'] = {
  ...
  blocksInScope: function() {
    const testBlock = this.getInputTargetBlock('TEST');
    if (testBlock) {
      return [testBlock];
    } else {
      return [];
...
Blockly.Blocks['lists_reduce'] = {
  ...
  blocksInScope: function() {
    const combineBlock = this.getInputTargetBlock('COMBINE');
    if (combineBlock) {
      return [combineBlock];
    } else {
      return [];
...
Blockly.Blocks['lists_sort_comparator'] = {
  ...
  blocksInScope: function() {
    const compareBlock = this.getInputTargetBlock('COMPARE');
    if (compareBlock) {
      return [compareBlock];
    } else {
      return [];
...
Blockly.Blocks['lists_sort_key'] = {
  ...
  blocksInScope: function() {
    const keyBlock = this.getInputTargetBlock('KEY');
    if (keyBlock) {
      return [keyBlock];
    } else {
      return [];
