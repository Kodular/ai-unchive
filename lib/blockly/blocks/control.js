...
Blockly.Blocks['controls_forRange'] = {
  init: function () {
    ...
    this.appendValueInput('START')
        ...
        .appendField(new Blockly.FieldParameterName(''), 'VAR')
...
Blockly.Blocks['controls_for_each_dict'] = {
  ...
  init: function() {
    ...
    this.appendValueInput('DICT')
        .appendField(Messages.forEach_)
        .appendField(new Blockly.FieldParameterName(''), 'KEY')
        .appendField(Messages.with_)
        .appendField(new Blockly.FieldParameterName(''), 'VALUE')
